            ...
            <div class="col-sm-2">
                <div class="row">
                    ...
                    if (Blog::print('facebook')) {
                        $url = HtmlPurifier::process('https://www.facebook.com/' . Blog::print('facebook'));
                        $logo = Html::img(Yii::getAlias('@web/cdn/image/social/facebook.svg'), ['style' => 'margin: auto;', 'class' => 'img-fluid rounded', 'alt' => $url]);
                        echo '<div class="col-sm-4 pull-left mb10">' . Html::a($logo, $url, ['style' => 'text-align: center;']) . '</div>';
                    }
                    ?>
                    <?php
                    if (Blog::print('twitter')) {
                        $url = HtmlPurifier::process('https://twitter.com/' . Blog::print('twitter'));
                    ...
                    if (Blog::print('telegram')) {
                        $url = HtmlPurifier::process('https://telegram.me/' . Blog::print('telegram'));
                    ...
                    if (Blog::print('instagram')) {
                        $url = HtmlPurifier::process('https://www.instagram.com/' . Blog::print('instagram'));
