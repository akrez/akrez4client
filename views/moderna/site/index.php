...
<div class="v1-default-index">
    <h1 style="display: inline-block;"><?= Blog::print('title') ?></h1><h2 class="mt-0 h2text <?= Blog::isRtl() ? 'mr-2' : 'ml-2' ?>" style="display: inline-block;"><?= Blog::print('slug') ?></h2><?= HtmlPurifier::process($page) ?>
</div>
